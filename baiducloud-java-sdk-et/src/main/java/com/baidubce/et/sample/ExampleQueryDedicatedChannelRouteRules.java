...
public class ExampleQueryDedicatedChannelRouteRules {
    public static void main(String[] args) {
        ...
        try {
            QueryDedicatedChannelRouteRulesResponse response = client.queryDedicatedChannelRouteRules(queryDedicatedChannelRouteRulesRequest);
