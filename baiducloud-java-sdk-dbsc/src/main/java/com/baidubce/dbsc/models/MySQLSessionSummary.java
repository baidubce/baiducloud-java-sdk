...
public class MySQLSessionSummary {
    /**
     * 活跃会话平均执行时间
     */
    ...
    public MySQLSessionSummary setActiveAverageExecuteTime(Double activeAverageExecuteTime) {
    ...
    public MySQLSessionSummary setActiveMaxExecuteTime(Double activeMaxExecuteTime) {
    ...
    public MySQLSessionSummary setActiveTotalCount(Integer activeTotalCount) {
    ...
    public MySQLSessionSummary setActiveTotalExecuteTime(Double activeTotalExecuteTime) {
    ...
    public MySQLSessionSummary setAverageExecuteTime(Double averageExecuteTime) {
    ...
    public MySQLSessionSummary setMaxExecuteTime(Double maxExecuteTime) {
    ...
    public MySQLSessionSummary setTotalCount(Integer totalCount) {
    ...
    public MySQLSessionSummary setTotalExecuteTime(Double totalExecuteTime) {
    ...
    public String toString() {
        return "MySQLSessionSummary{" + "activeAverageExecuteTime=" + activeAverageExecuteTime + "\n" + "activeMaxExecuteTime=" + activeMaxExecuteTime + "\n" + "activeTotalCount="
