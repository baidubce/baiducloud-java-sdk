...
public class MysqlSessionHostSummary {
    /**
     * 数据库源主机
     */
    private String host;
    ...
    public MysqlSessionHostSummary setHost(String host) {
        this.host = host;
        return this;
    }
    ...
    public MysqlSessionHostSummary setActiveAverageExecuteTime(Double activeAverageExecuteTime) {
    ...
    public MysqlSessionHostSummary setActiveMaxExecuteTime(Double activeMaxExecuteTime) {
    ...
    public MysqlSessionHostSummary setActiveTotalCount(Integer activeTotalCount) {
    ...
    public MysqlSessionHostSummary setActiveTotalExecuteTime(Double activeTotalExecuteTime) {
    ...
    public MysqlSessionHostSummary setAverageExecuteTime(Double averageExecuteTime) {
    ...
    public MysqlSessionHostSummary setMaxExecuteTime(Double maxExecuteTime) {
    ...
    public MysqlSessionHostSummary setTotalCount(Integer totalCount) {
    ...
    public MysqlSessionHostSummary setTotalExecuteTime(Double totalExecuteTime) {
