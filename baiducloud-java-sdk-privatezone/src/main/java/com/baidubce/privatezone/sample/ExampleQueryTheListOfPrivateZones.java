...
public class ExampleQueryTheListOfPrivateZones {
    public static void main(String[] args) {
        ...
        try {
            QueryTheListOfPrivateZonesResponse response = client.queryTheListOfPrivateZones(queryTheListOfPrivateZonesRequest);
