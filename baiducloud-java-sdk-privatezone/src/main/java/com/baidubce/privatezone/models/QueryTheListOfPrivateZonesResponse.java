...
public class QueryTheListOfPrivateZonesResponse extends BaseBceResponse {
    /**
     * 标记查询的起始位置
     */
     ...
     * Zone的集合
     */
    private List<PrivateZone> zones;
    ...
    public String toString() {
        return "QueryTheListOfPrivateZonesResponse{" + "marker=" + marker + "\n" + "isTruncated=" + isTruncated + "\n" + "nextMarker=" + nextMarker + "\n" + "maxKeys=" + maxKeys
                + "\n" + "zones=" + zones + "\n" + "}";
    }
