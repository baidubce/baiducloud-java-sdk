...
public class ExampleGetApplicationParameterTemplateRecords {
    public static void main(String[] args) {
        ...
        try {
            GetApplicationParameterTemplateRecordsResponse response = client.getApplicationParameterTemplateRecords(getApplicationParameterTemplateRecordsRequest);
