...
import com.baidubce.scs.models.Parameter;

public class ExampleModifyParameters {
    public static void main(String[] args) {
        ...
        parameter.setForceRestart(0);
        parameter.setName("");
        parameter.setValue("");

        ModifyParametersRequest modifyParametersRequest = new ModifyParametersRequest();
        modifyParametersRequest.setInstanceId("");
        modifyParametersRequest.setParameter(parameter);
        try {
            client.modifyParameters(modifyParametersRequest);
