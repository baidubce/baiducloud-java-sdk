...
public class ExampleApmUpdateAlarmPolicyState {
    public static void main(String[] args) {
        ...
        try {
            ApmUpdateAlarmPolicyStateResponse response = client.apmUpdateAlarmPolicyState(apmUpdateAlarmPolicyStateRequest);
