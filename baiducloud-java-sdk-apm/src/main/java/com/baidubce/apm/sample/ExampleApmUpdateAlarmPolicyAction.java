...
public class ExampleApmUpdateAlarmPolicyAction {
    public static void main(String[] args) {
        ...
        try {
            ApmUpdateAlarmPolicyActionResponse response = client.apmUpdateAlarmPolicyAction(apmUpdateAlarmPolicyActionRequest);
