...
public class ExampleDescribeLLMSessionsStatistics {
    public static void main(String[] args) {
        ...
        try {
            DescribeLLMSessionsStatisticsResponse response = client.describeLLMSessionsStatistics(describeLLMSessionsStatisticsRequest);
