...
public class ExampleDescribeLLMDimensionValues {
    public static void main(String[] args) {
        ...
        try {
            DescribeLLMDimensionValuesResponse response = client.describeLLMDimensionValues(describeLLMDimensionValuesRequest);
