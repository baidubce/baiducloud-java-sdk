...
import com.baidubce.cprom.models.PodMonitor;
import com.baidubce.cprom.models.NamespaceSelector;
import java.util.ArrayList;

public class ExampleUpdatePodMonitor {
    public static void main(String[] args) {
        ...
        podMonitor.setApiVersion("");
        podMonitor.setKind("");
        ObjectMeta metadata = new ObjectMeta();
        metadata.setName("");
        metadata.setNamespace("");

        podMonitor.setMetadata(metadata);
        ...
        updatePodMonitorRequest.setPodMonitor(podMonitor);
        try {
            client.updatePodMonitor(updatePodMonitorRequest);
