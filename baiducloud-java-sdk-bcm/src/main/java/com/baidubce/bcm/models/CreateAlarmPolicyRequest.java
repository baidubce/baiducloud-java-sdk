...
public class CreateAlarmPolicyRequest extends BaseBceRequest {
    ...
    */
    ...
    public CreateAlarmPolicyRequest setScope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public CreateAlarmPolicyRequest setResourceType(String resourceType) {
    ...
    public CreateAlarmPolicyRequest setTarget(AlarmTarget target) {
        this.target = target;
        return this;
    }
    ...
    public CreateAlarmPolicyRequest setRules(List<AlarmRule> rules) {
        this.rules = rules;
        return this;
    }
    ...
    public CreateAlarmPolicyRequest setOnMissingData(String onMissingData) {
    ...
    public CreateAlarmPolicyRequest setNoDataNotifyPendingMinutes(Integer noDataNotifyPendingMinutes) {
    ...
    public CreateAlarmPolicyRequest setType(String type) {
        this.type = type;
        return this;
    }
    ...
    public CreateAlarmPolicyRequest setLevel(String level) {
        this.level = level;
        return this;
    }
    ...
    public CreateAlarmPolicyRequest setActions(List<PolicyAction> actions) {
    ...
    public CreateAlarmPolicyRequest setNotifyEnabled(Boolean notifyEnabled) {
    ...
    public CreateAlarmPolicyRequest setCallbacks(List<Callback> callbacks) {
    ...
    public CreateAlarmPolicyRequest setRenotifyCount(Integer renotifyCount) {
    ...
    public CreateAlarmPolicyRequest setRenotifyIntervalMinutes(Integer renotifyIntervalMinutes) {
    ...
    public CreateAlarmPolicyRequest setNotifyMergeWindowSeconds(Integer notifyMergeWindowSeconds) {
