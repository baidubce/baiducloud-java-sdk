...
public class ExampleQueryTheListOfRegularSecurityGroupsV2 {
    public static void main(String[] args) {
        ...
        try {
            QueryTheListOfRegularSecurityGroupsV2Response response = client.queryTheListOfRegularSecurityGroupsV2(queryTheListOfRegularSecurityGroupsV2Request);
