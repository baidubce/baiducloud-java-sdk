...
public class ExampleClosePeerToPeerConnectionToSynchronizeDns {
    public static void main(String[] args) {
        ...
        try {
            client.closePeerToPeerConnectionToSynchronizeDns(closePeerToPeerConnectionToSynchronizeDnsRequest);
