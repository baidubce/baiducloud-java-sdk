...
public class ExampleAddElasticNetworkCardAuxiliaryIp {
    public static void main(String[] args) {
        ...
        try {
            AddElasticNetworkCardAuxiliaryIpResponse response = client.addElasticNetworkCardAuxiliaryIp(addElasticNetworkCardAuxiliaryIpRequest);
