...
public class ExampleElasticNetworkCardMountedCloudProductInstance {
    public static void main(String[] args) {
        ...
        try {
            client.elasticNetworkCardMountedCloudProductInstance(elasticNetworkCardMountedCloudProductInstanceRequest);
