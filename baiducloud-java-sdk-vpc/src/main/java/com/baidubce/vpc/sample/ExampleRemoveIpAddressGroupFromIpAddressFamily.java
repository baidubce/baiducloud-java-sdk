...
public class ExampleRemoveIpAddressGroupFromIpAddressFamily {
    public static void main(String[] args) {
        ...
        try {
            client.removeIpAddressGroupFromIpAddressFamily(removeIpAddressGroupFromIpAddressFamilyRequest);
