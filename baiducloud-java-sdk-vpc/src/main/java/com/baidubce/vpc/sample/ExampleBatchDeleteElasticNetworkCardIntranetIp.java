...
public class ExampleBatchDeleteElasticNetworkCardIntranetIp {
    public static void main(String[] args) {
        ...
        try {
            client.batchDeleteElasticNetworkCardIntranetIp(batchDeleteElasticNetworkCardIntranetIpRequest);
