...
public class ExampleElasticNetworkCardUpdateEnterpriseSecurityGroup {
    public static void main(String[] args) {
        ...
        try {
            client.elasticNetworkCardUpdateEnterpriseSecurityGroup(elasticNetworkCardUpdateEnterpriseSecurityGroupRequest);
