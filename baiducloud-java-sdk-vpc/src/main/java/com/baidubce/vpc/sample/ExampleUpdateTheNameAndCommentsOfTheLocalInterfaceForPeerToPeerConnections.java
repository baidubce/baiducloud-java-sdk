...
public class ExampleUpdateTheNameAndCommentsOfTheLocalInterfaceForPeerToPeerConnections {
    public static void main(String[] args) {
        ...
        try {
            client.updateTheNameAndCommentsOfTheLocalInterfaceForPeerToPeerConnections(updateTheNameAndCommentsOfTheLocalInterfaceForPeerToPeerConnectionsRequest);
