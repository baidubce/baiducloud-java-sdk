...
public class ExampleElasticNetworkCardUpdatesRegularSecurityGroup {
    public static void main(String[] args) {
        ...
        try {
            client.elasticNetworkCardUpdatesRegularSecurityGroup(elasticNetworkCardUpdatesRegularSecurityGroupRequest);
