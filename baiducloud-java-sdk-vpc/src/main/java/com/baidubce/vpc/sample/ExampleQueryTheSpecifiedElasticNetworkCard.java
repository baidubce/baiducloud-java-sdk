...
public class ExampleQueryTheSpecifiedElasticNetworkCard {
    public static void main(String[] args) {
        ...
        try {
            QueryTheSpecifiedElasticNetworkCardResponse response = client.queryTheSpecifiedElasticNetworkCard(queryTheSpecifiedElasticNetworkCardRequest);
