...
public class ExampleQueryTheSpecifiedHighlyAvailableVirtualIp {
    public static void main(String[] args) {
        ...
        try {
            QueryTheSpecifiedHighlyAvailableVirtualIpResponse response = client.queryTheSpecifiedHighlyAvailableVirtualIp(queryTheSpecifiedHighlyAvailableVirtualIpRequest);
