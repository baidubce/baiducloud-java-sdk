...
public class ExampleUpdateIpv6GatewayReleaseProtectionSwitch {
    public static void main(String[] args) {
        ...
        try {
            client.updateIpv6GatewayReleaseProtectionSwitch(updateIpv6GatewayReleaseProtectionSwitchRequest);
