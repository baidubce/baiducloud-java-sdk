...
public class ExampleIpv6GatewayBandwidthUpgradeAndDowngrade {
    public static void main(String[] args) {
        ...
        try {
            client.ipv6GatewayBandwidthUpgradeAndDowngrade(ipv6GatewayBandwidthUpgradeAndDowngradeRequest);
