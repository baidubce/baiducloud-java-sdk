...
public class ExampleHighAvailabilityVirtualIpUnbindingInstance {
    public static void main(String[] args) {
        ...
        try {
            client.highAvailabilityVirtualIpUnbindingInstance(highAvailabilityVirtualIpUnbindingInstanceRequest);
