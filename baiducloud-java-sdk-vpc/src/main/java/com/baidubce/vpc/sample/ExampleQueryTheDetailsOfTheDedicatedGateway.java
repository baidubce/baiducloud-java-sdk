...
public class ExampleQueryTheDetailsOfTheDedicatedGateway {
    public static void main(String[] args) {
        ...
        try {
            QueryTheDetailsOfTheDedicatedGatewayResponse response = client.queryTheDetailsOfTheDedicatedGateway(queryTheDetailsOfTheDedicatedGatewayRequest);
