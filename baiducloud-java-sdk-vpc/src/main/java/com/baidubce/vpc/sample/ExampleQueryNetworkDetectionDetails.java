...
public class ExampleQueryNetworkDetectionDetails {
    public static void main(String[] args) {
        ...
        try {
            QueryNetworkDetectionDetailsResponse response = client.queryNetworkDetectionDetails(queryNetworkDetectionDetailsRequest);
