...
public class ExampleQueryTheListOfIpAddressGroups {
    public static void main(String[] args) {
        ...
        try {
            QueryTheListOfIpAddressGroupsResponse response = client.queryTheListOfIpAddressGroups(queryTheListOfIpAddressGroupsRequest);
