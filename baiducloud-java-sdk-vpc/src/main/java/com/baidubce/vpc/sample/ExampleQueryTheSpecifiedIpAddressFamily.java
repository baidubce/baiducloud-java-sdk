...
public class ExampleQueryTheSpecifiedIpAddressFamily {
    public static void main(String[] args) {
        ...
        try {
            QueryTheSpecifiedIpAddressFamilyResponse response = client.queryTheSpecifiedIpAddressFamily(queryTheSpecifiedIpAddressFamilyRequest);
