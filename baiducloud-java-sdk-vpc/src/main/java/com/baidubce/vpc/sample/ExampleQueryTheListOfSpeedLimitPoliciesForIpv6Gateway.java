...
public class ExampleQueryTheListOfSpeedLimitPoliciesForIpv6Gateway {
    public static void main(String[] args) {
        ...
        try {
            QueryTheListOfSpeedLimitPoliciesForIpv6GatewayResponse response =
                    client.queryTheListOfSpeedLimitPoliciesForIpv6Gateway(queryTheListOfSpeedLimitPoliciesForIpv6GatewayRequest);
