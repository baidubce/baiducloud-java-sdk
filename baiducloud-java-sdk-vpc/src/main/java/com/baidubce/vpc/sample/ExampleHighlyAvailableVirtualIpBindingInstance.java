...
public class ExampleHighlyAvailableVirtualIpBindingInstance {
    public static void main(String[] args) {
        ...
        try {
            client.highlyAvailableVirtualIpBindingInstance(highlyAvailableVirtualIpBindingInstanceRequest);
