...
public class ExampleRevokeRegularSecurityGroupRulesV2 {
    public static void main(String[] args) {
        ...
        revokeRegularSecurityGroupRulesV2Request.setRule(rule);
        try {
            client.revokeRegularSecurityGroupRulesV2(revokeRegularSecurityGroupRulesV2Request);
