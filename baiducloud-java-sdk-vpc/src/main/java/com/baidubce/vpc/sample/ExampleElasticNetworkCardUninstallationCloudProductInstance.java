...
public class ExampleElasticNetworkCardUninstallationCloudProductInstance {
    public static void main(String[] args) {
        ...
        try {
            client.elasticNetworkCardUninstallationCloudProductInstance(elasticNetworkCardUninstallationCloudProductInstanceRequest);
