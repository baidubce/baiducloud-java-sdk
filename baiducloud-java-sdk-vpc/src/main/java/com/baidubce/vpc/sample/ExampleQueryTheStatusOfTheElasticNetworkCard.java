...
public class ExampleQueryTheStatusOfTheElasticNetworkCard {
    public static void main(String[] args) {
        ...
        try {
            QueryTheStatusOfTheElasticNetworkCardResponse response = client.queryTheStatusOfTheElasticNetworkCard(queryTheStatusOfTheElasticNetworkCardRequest);
