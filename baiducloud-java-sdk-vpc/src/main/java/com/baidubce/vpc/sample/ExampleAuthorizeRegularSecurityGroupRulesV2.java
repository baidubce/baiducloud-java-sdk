...
public class ExampleAuthorizeRegularSecurityGroupRulesV2 {
    public static void main(String[] args) {
        ...
        authorizeRegularSecurityGroupRulesV2Request.setRule(rule);
        try {
            client.authorizeRegularSecurityGroupRulesV2(authorizeRegularSecurityGroupRulesV2Request);
