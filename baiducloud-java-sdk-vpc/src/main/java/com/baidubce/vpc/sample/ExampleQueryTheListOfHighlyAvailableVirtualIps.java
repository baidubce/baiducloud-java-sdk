...
public class ExampleQueryTheListOfHighlyAvailableVirtualIps {
    public static void main(String[] args) {
        ...
        try {
            QueryTheListOfHighlyAvailableVirtualIpsResponse response = client.queryTheListOfHighlyAvailableVirtualIps(queryTheListOfHighlyAvailableVirtualIpsRequest);
