...
public class QueryTheListOfHighlyAvailableVirtualIpsResponse extends BaseBceResponse {
    ...
    */
    ...
    public String toString() {
        return "QueryTheListOfHighlyAvailableVirtualIpsResponse{" + "haVips=" + haVips + "\n" + "marker=" + marker + "\n" + "isTruncated=" + isTruncated + "\n" + "nextMarker="
                + nextMarker + "\n" + "maxKeys=" + maxKeys + "\n" + "}";
    }
