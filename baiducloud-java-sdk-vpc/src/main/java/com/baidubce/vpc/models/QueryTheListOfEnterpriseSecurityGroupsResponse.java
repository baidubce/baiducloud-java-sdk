...
public class QueryTheListOfEnterpriseSecurityGroupsResponse extends BaseBceResponse {
    ...
    */
    ...
    public String toString() {
        return "QueryTheListOfEnterpriseSecurityGroupsResponse{" + "marker=" + marker + "\n" + "isTruncated=" + isTruncated + "\n" + "nextMarker=" + nextMarker + "\n" + "maxKeys="
