...
public class VpcClientTest {
  ...
  public void batchCreateSslVpnUsersTest() {
    BatchCreateSslVpnUsersRequest batchCreateSslVpnUsersRequest =
        new BatchCreateSslVpnUsersRequest();
    ...
    BatchCreateSslVpnUsersResponse response =
        vpcClient.batchCreateSslVpnUsers(batchCreateSslVpnUsersRequest);
  ...
  public void searchForVpnDetailsTest() {
    ...
    SearchForVpnDetailsResponse response =
        vpcClient.searchForVpnDetails(searchForVpnDetailsRequest);
    System.out.println(response);
  }
  ...
  public void updateVpnReleaseProtectionTest() {
    UpdateVpnReleaseProtectionRequest updateVpnReleaseProtectionRequest =
        new UpdateVpnReleaseProtectionRequest();
