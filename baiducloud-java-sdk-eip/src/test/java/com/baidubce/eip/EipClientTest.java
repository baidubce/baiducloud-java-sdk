...
public class EipClientTest {
  ...
  public void addTbspProtocolBlockingTest() {
    AddTbspProtocolBlockingRequest addTbspProtocolBlockingRequest =
        new AddTbspProtocolBlockingRequest();
  ...
  public void bandwidthPackageInquiryTest() {
    ...
    BandwidthPackageInquiryResponse response =
        eipClient.bandwidthPackageInquiry(bandwidthPackageInquiryRequest);
    System.out.println(response);
  }
  ...
  public void bindTbspProtectionObjectTest() {
    BindTbspProtectionObjectRequest bindTbspProtectionObjectRequest =
        new BindTbspProtectionObjectRequest();
  ...
  public void eipBandwidthScalingCapacityTest() {
    EipBandwidthScalingCapacityRequest eipBandwidthScalingCapacityRequest =
        new EipBandwidthScalingCapacityRequest();
  ...
  public void listTbspAreaBlockingTest() {
    ...
    ListTbspAreaBlockingResponse response =
        eipClient.listTbspAreaBlocking(listTbspAreaBlockingRequest);
    System.out.println(response);
  }
  ...
  public void listTbspIpWhitelistTest() {
    ...
    ListTbspIpWhitelistResponse response =
        eipClient.listTbspIpWhitelist(listTbspIpWhitelistRequest);
    System.out.println(response);
  }
  ...
  public void listTbspProtocolBlockingTest() {
    ListTbspProtocolBlockingRequest listTbspProtocolBlockingRequest =
        new ListTbspProtocolBlockingRequest();
    listTbspProtocolBlockingRequest.setId("");
    listTbspProtocolBlockingRequest.setIp("");
    ListTbspProtocolBlockingResponse response =
        eipClient.listTbspProtocolBlocking(listTbspProtocolBlockingRequest);
    System.out.println(response);
  }
  ...
  public void modifyTbspIpProtectLevelTest() {
    ModifyTbspIpProtectLevelRequest modifyTbspIpProtectLevelRequest =
        new ModifyTbspIpProtectLevelRequest();
  ...
  public void removeTbspProtocolBlockingTest() {
    RemoveTbspProtocolBlockingRequest removeTbspProtocolBlockingRequest =
        new RemoveTbspProtocolBlockingRequest();
  ...
  public void sharedBandwidthInquiryTest() {
    SharedBandwidthInquiryRequest sharedBandwidthInquiryRequest =
        new SharedBandwidthInquiryRequest();
    ...
    SharedBandwidthInquiryResponse response =
        eipClient.sharedBandwidthInquiry(sharedBandwidthInquiryRequest);
    System.out.println(response);
  }
  ...
  public void sharedDataPackageInquiryTest() {
    SharedDataPackageInquiryRequest sharedDataPackageInquiryRequest =
        new SharedDataPackageInquiryRequest();
    ...
    SharedDataPackageInquiryResponse response =
        eipClient.sharedDataPackageInquiry(sharedDataPackageInquiryRequest);
    System.out.println(response);
  }
  ...
  public void unbindTbspProtectionObjectTest() {
    UnbindTbspProtectionObjectRequest unbindTbspProtectionObjectRequest =
        new UnbindTbspProtectionObjectRequest();
  ...
  public void updateEipDeleteProtectTest() {
    UpdateEipDeleteProtectRequest updateEipDeleteProtectRequest =
        new UpdateEipDeleteProtectRequest();
