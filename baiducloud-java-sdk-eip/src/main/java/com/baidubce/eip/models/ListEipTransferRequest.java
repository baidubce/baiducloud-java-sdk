...
public class ListEipTransferRequest {
  ...
  /** transferId */
  @JsonIgnore private String transferId;

  /** status */
  @JsonIgnore private String status;

  /** fuzzyTransferId */
  @JsonIgnore private String fuzzyTransferId;

  /** fuzzyInstanceId */
  @JsonIgnore private String fuzzyInstanceId;

  /** fuzzyInstanceName */
  @JsonIgnore private String fuzzyInstanceName;

  /** fuzzyInstanceIp */
  @JsonIgnore private String fuzzyInstanceIp;
