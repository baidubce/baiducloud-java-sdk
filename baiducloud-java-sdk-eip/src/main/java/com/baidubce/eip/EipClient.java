...
public class EipClient extends AbstractBceClient {
  ...
  private static HttpResponseHandler[] EipClientHandlers =
  ...
  public void addTbspAreaBlocking(AddTbspAreaBlockingRequest request) {
    ...
    checkNotNull(
        request.getId(), "Missing the required parameter 'id' when calling addTbspAreaBlocking");
  ...
  public void addTbspIpWhitelist(AddTbspIpWhitelistRequest request) {
    // verify the required parameter 'id' is set
    checkNotNull(
        request.getId(), "Missing the required parameter 'id' when calling addTbspIpWhitelist");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
  ...
  public void addTbspProtocolBlocking(AddTbspProtocolBlockingRequest request) {
    ...
    checkNotNull(
        request.getId(),
        "Missing the required parameter 'id' when calling addTbspProtocolBlocking");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
  ...
  public ApplyForEipResponse applyForEip(ApplyForEipRequest request) {
    ...
    checkNotNull(
        request.getBandwidthInMbps(),
        "Missing the required parameter 'bandwidthInMbps' when calling applyForEip");
    // verify the required parameter 'billing' is set
    checkNotNull(
        request.getBilling(), "Missing the required parameter 'billing' when calling applyForEip");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.POST, VERSION_V1, CONSTANT_EIP);
    if (request.getClientToken() != null) {
      internalRequest.addParameter("clientToken", request.getClientToken());
    }
    fillPayload(internalRequest, request);
   ...
   */
  public BandwidthPackageInquiryResponse bandwidthPackageInquiry(
      BandwidthPackageInquiryRequest request) {
    // verify the required parameter 'bandwidthInMbps' is set
    checkNotNull(
        request.getBandwidthInMbps(),
        "Missing the required parameter 'bandwidthInMbps' when calling bandwidthPackageInquiry");
    InternalRequest internalRequest =
        this.createRequest(
            request, HttpMethodName.POST, VERSION_V1, CONSTANT_EIPBP, CONSTANT_PRICE);
    fillPayload(internalRequest, request);
  ...
  public void bindEip(BindEipRequest request) {
    ...
    checkNotNull(
        ...
        "Missing the required parameter 'instanceType' when calling bindEip");
    // verify the required parameter 'instanceId' is set
    checkNotNull(
        request.getInstanceId(),
        "Missing the required parameter 'instanceId' when calling bindEip");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.PUT, VERSION_V1, CONSTANT_EIP, request.getEip());
  ...
  public void bindTbspProtectionObject(BindTbspProtectionObjectRequest request) {
    ...
    checkNotNull(
        request.getId(),
        "Missing the required parameter 'id' when calling bindTbspProtectionObject");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    ...
    checkNotNull(
        request.getIpList(),
        "Missing the required parameter 'ipList' when calling bindTbspProtectionObject");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.PUT, VERSION_V1, CONSTANT_TBSP, request.getId());
    internalRequest.addParameter("bind", null);
    if (request.getClientToken() != null) {
      internalRequest.addParameter("clientToken", request.getClientToken());
    }
  ...
  public void cancelEipTransfer(CancelEipTransferRequest request) {
    ...
    checkNotNull(
        request.getTransferIdList(),
        "Missing the required parameter 'transferIdList' when calling cancelEipTransfer");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.PUT, VERSION_V1, CONSTANT_TRANSFER);
  ...
  public CreateEipTransferResponse createEipTransfer(CreateEipTransferRequest request) {
    ...
    checkNotNull(
        ...
        "Missing the required parameter 'transferType' when calling createEipTransfer");
    // verify the required parameter 'transferResourceList' is set
    checkNotNull(
        request.getTransferResourceList(),
        "Missing the required parameter 'transferResourceList' when calling createEipTransfer");
    // verify the required parameter 'toUserId' is set
    checkNotNull(
        request.getToUserId(),
        "Missing the required parameter 'toUserId' when calling createEipTransfer");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.POST, VERSION_V1, CONSTANT_TRANSFER);
    if (request.getClientToken() != null) {
      internalRequest.addParameter("clientToken", request.getClientToken());
    }
    fillPayload(internalRequest, request);
  ...
  public CreateTbspResponse createTbsp(CreateTbspRequest request) {
    ...
    checkNotNull(
        request.getName(), "Missing the required parameter 'name' when calling createTbsp");
    // verify the required parameter 'lineType' is set
    checkNotNull(
        request.getLineType(), "Missing the required parameter 'lineType' when calling createTbsp");
    // verify the required parameter 'ipCapacity' is set
    checkNotNull(
        request.getIpCapacity(),
        "Missing the required parameter 'ipCapacity' when calling createTbsp");
    // verify the required parameter 'reservationLength' is set
    checkNotNull(
        request.getReservationLength(),
        "Missing the required parameter 'reservationLength' when calling createTbsp");
    // verify the required parameter 'reservationTimeUnit' is set
    checkNotNull(
        request.getReservationTimeUnit(),
        "Missing the required parameter 'reservationTimeUnit' when calling createTbsp");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.POST, VERSION_V1, CONSTANT_TBSP);
    if (request.getClientToken() != null) {
      internalRequest.addParameter("clientToken", request.getClientToken());
    }
    fillPayload(internalRequest, request);
  ...
  public DetailTbspResponse detailTbsp(DetailTbspRequest request) {
    ...
    InternalRequest internalRequest =
        this.createRequest(
            new BaseBceRequest(), HttpMethodName.GET, VERSION_V1, CONSTANT_TBSP, request.getId());
  ...
  public void directEip(DirectEipRequest request) {
    // verify the required parameter 'eip' is set
    checkNotNull(request.getEip(), "Missing the required parameter 'eip' when calling directEip");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
        this.createRequest(
            new BaseBceRequest(), HttpMethodName.PUT, VERSION_V1, CONSTANT_EIP, request.getEip());
  ...
  public void disableTbspIpClean(DisableTbspIpCleanRequest request) {
    // verify the required parameter 'id' is set
    checkNotNull(
        request.getId(), "Missing the required parameter 'id' when calling disableTbspIpClean");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
  ...
  public void eipBandwidthScalingCapacity(EipBandwidthScalingCapacityRequest request) {
    ...
    checkNotNull(
        request.getEip(),
        "Missing the required parameter 'eip' when calling eipBandwidthScalingCapacity");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    // verify the required parameter 'newBandwidthInMbps' is set
    checkNotNull(
        request.getNewBandwidthInMbps(),
        "Missing the required parameter 'newBandwidthInMbps' when calling eipBandwidthScalingCapacity");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.PUT, VERSION_V1, CONSTANT_EIP, request.getEip());
  ...
  public EipInquiryResponse eipInquiry(EipInquiryRequest request) {
    ...
    checkNotNull(
        request.getBandwidthInMbps(),
        "Missing the required parameter 'bandwidthInMbps' when calling eipInquiry");
    // verify the required parameter 'billing' is set
    checkNotNull(
        request.getBilling(), "Missing the required parameter 'billing' when calling eipInquiry");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.POST, VERSION_V1, CONSTANT_EIP, CONSTANT_PRICE);
    fillPayload(internalRequest, request);
  ...
  public void eipPostpaidToPrepaid(EipPostpaidToPrepaidRequest request) {
    // verify the required parameter 'eip' is set
    checkNotNull(
        request.getEip(), "Missing the required parameter 'eip' when calling eipPostpaidToPrepaid");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    // verify the required parameter 'purchaseLength' is set
    checkNotNull(
        request.getPurchaseLength(),
        "Missing the required parameter 'purchaseLength' when calling eipPostpaidToPrepaid");
    // verify the required parameter 'bandWidth' is set
    checkNotNull(
        request.getBandWidth(),
        "Missing the required parameter 'bandWidth' when calling eipPostpaidToPrepaid");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.PUT, VERSION_V1, CONSTANT_EIP, request.getEip());
  ...
  public void eipRenewal(EipRenewalRequest request) {
    ...
    // verify the required parameter 'billing' is set
    checkNotNull(
        request.getBilling(), "Missing the required parameter 'billing' when calling eipRenewal");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.PUT, VERSION_V1, CONSTANT_EIP, request.getEip());
  ...
  public void enableTbspIpClean(EnableTbspIpCleanRequest request) {
    // verify the required parameter 'id' is set
    checkNotNull(
        request.getId(), "Missing the required parameter 'id' when calling enableTbspIpClean");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
  ...
  public ListEipTransferResponse listEipTransfer(ListEipTransferRequest request) {
    InternalRequest internalRequest =
        this.createRequest(new BaseBceRequest(), HttpMethodName.GET, VERSION_V1, CONSTANT_TRANSFER);
  ...
  public ListRecycleEipsResponse listRecycleEips(ListRecycleEipsRequest request) {
    InternalRequest internalRequest =
        this.createRequest(
            new BaseBceRequest(), HttpMethodName.GET, VERSION_V1, CONSTANT_EIP, CONSTANT_RECYCLE);
  ...
  public ListTbspResponse listTbsp(ListTbspRequest request) {
    InternalRequest internalRequest =
        this.createRequest(new BaseBceRequest(), HttpMethodName.GET, VERSION_V1, CONSTANT_TBSP);
  ...
  public ListTbspAreaBlockingResponse listTbspAreaBlocking(ListTbspAreaBlockingRequest request) {
    // verify the required parameter 'id' is set
    checkNotNull(
        request.getId(), "Missing the required parameter 'id' when calling listTbspAreaBlocking");
    InternalRequest internalRequest =
        this.createRequest(
            new BaseBceRequest(),
            HttpMethodName.GET,
  ...
  public ListTbspIpCleanResponse listTbspIpClean(ListTbspIpCleanRequest request) {
    // verify the required parameter 'id' is set
    checkNotNull(
        request.getId(), "Missing the required parameter 'id' when calling listTbspIpClean");
    InternalRequest internalRequest =
        this.createRequest(
            new BaseBceRequest(),
            HttpMethodName.GET,
  ...
  public ListTbspIpWhitelistResponse listTbspIpWhitelist(ListTbspIpWhitelistRequest request) {
    // verify the required parameter 'id' is set
    checkNotNull(
        request.getId(), "Missing the required parameter 'id' when calling listTbspIpWhitelist");
    InternalRequest internalRequest =
        this.createRequest(
            new BaseBceRequest(),
            HttpMethodName.GET,
   ...
   */
  public ListTbspProtocolBlockingResponse listTbspProtocolBlocking(
      ListTbspProtocolBlockingRequest request) {
    // verify the required parameter 'id' is set
    checkNotNull(
        request.getId(),
        "Missing the required parameter 'id' when calling listTbspProtocolBlocking");
    InternalRequest internalRequest =
        this.createRequest(
            new BaseBceRequest(),
            HttpMethodName.GET,
  ...
  public void modifyTbspIpCleanThreshold(ModifyTbspIpCleanThresholdRequest request) {
    ...
    checkNotNull(
        request.getId(),
        "Missing the required parameter 'id' when calling modifyTbspIpCleanThreshold");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
  ...
  public void modifyTbspIpProtectLevel(ModifyTbspIpProtectLevelRequest request) {
    ...
    checkNotNull(
        request.getId(),
        "Missing the required parameter 'id' when calling modifyTbspIpProtectLevel");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
  ...
  public void optionalReleaseEip(OptionalReleaseEipRequest request) {
    // verify the required parameter 'eip' is set
    checkNotNull(
        request.getEip(), "Missing the required parameter 'eip' when calling optionalReleaseEip");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
    ...
    if (request.getReleaseToRecycle() != null) {
      internalRequest.addParameter(
          "releaseToRecycle", String.valueOf(request.getReleaseToRecycle()));
    }
    if (request.getClientToken() != null) {
      internalRequest.addParameter("clientToken", request.getClientToken());
    }
  ...
  public QueryEipListResponse queryEipList(QueryEipListRequest request) {
    InternalRequest internalRequest =
        this.createRequest(new BaseBceRequest(), HttpMethodName.GET, VERSION_V1, CONSTANT_EIP);
  ...
  public void receiveEipTransfer(ReceiveEipTransferRequest request) {
    ...
    checkNotNull(
        request.getTransferIdList(),
        "Missing the required parameter 'transferIdList' when calling receiveEipTransfer");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.PUT, VERSION_V1, CONSTANT_TRANSFER);
  ...
  public void refundEip(RefundEipRequest request) {
    // verify the required parameter 'eip' is set
    checkNotNull(request.getEip(), "Missing the required parameter 'eip' when calling refundEip");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
  ...
  public void rejectEipTransfer(RejectEipTransferRequest request) {
    ...
    checkNotNull(
        request.getTransferIdList(),
        "Missing the required parameter 'transferIdList' when calling rejectEipTransfer");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.PUT, VERSION_V1, CONSTANT_TRANSFER);
  ...
  public void releaseEipFromRecycle(ReleaseEipFromRecycleRequest request) {
    ...
    checkNotNull(
        request.getEip(),
        "Missing the required parameter 'eip' when calling releaseEipFromRecycle");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
  ...
  public void removeTbspAreaBlocking(RemoveTbspAreaBlockingRequest request) {
    // verify the required parameter 'id' is set
    checkNotNull(
        request.getId(), "Missing the required parameter 'id' when calling removeTbspAreaBlocking");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
  ...
  public void removeTbspIpWhitelist(RemoveTbspIpWhitelistRequest request) {
    // verify the required parameter 'id' is set
    checkNotNull(
        request.getId(), "Missing the required parameter 'id' when calling removeTbspIpWhitelist");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
  ...
  public void removeTbspProtocolBlocking(RemoveTbspProtocolBlockingRequest request) {
    ...
    checkNotNull(
        request.getId(),
        "Missing the required parameter 'id' when calling removeTbspProtocolBlocking");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
  ...
  public void renewTbsp(RenewTbspRequest request) {
    ...
    checkNotNull(
        request.getRenewTime(),
        "Missing the required parameter 'renewTime' when calling renewTbsp");
    // verify the required parameter 'renewTimeUnit' is set
    checkNotNull(
        request.getRenewTimeUnit(),
        "Missing the required parameter 'renewTimeUnit' when calling renewTbsp");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.PUT, VERSION_V1, CONSTANT_TBSP, request.getId());
    internalRequest.addParameter("purchaseReserved", null);
    if (request.getClientToken() != null) {
  ...
  public void resizeTbsp(ResizeTbspRequest request) {
    ...
    checkNotNull(
        request.getIpCapacity(),
        "Missing the required parameter 'ipCapacity' when calling resizeTbsp");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.PUT, VERSION_V1, CONSTANT_TBSP, request.getId());
    internalRequest.addParameter("resize", null);
    if (request.getClientToken() != null) {
  ...
  public void restoreEipFromRecycle(RestoreEipFromRecycleRequest request) {
    ...
    checkNotNull(
        request.getEip(),
        "Missing the required parameter 'eip' when calling restoreEipFromRecycle");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
   ...
   */
  public SharedBandwidthInquiryResponse sharedBandwidthInquiry(
      SharedBandwidthInquiryRequest request) {
    // verify the required parameter 'bandwidthInMbps' is set
    checkNotNull(
        request.getBandwidthInMbps(),
        "Missing the required parameter 'bandwidthInMbps' when calling sharedBandwidthInquiry");
    // verify the required parameter 'ipNum' is set
    checkNotNull(
        request.getIpNum(),
        "Missing the required parameter 'ipNum' when calling sharedBandwidthInquiry");
    // verify the required parameter 'billing' is set
    checkNotNull(
        request.getBilling(),
        "Missing the required parameter 'billing' when calling sharedBandwidthInquiry");
    InternalRequest internalRequest =
        this.createRequest(
            request, HttpMethodName.POST, VERSION_V1, CONSTANT_EIPGROUP, CONSTANT_PRICE);
    fillPayload(internalRequest, request);
   ...
   */
  public SharedDataPackageInquiryResponse sharedDataPackageInquiry(
      SharedDataPackageInquiryRequest request) {
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    // verify the required parameter 'reservationLength' is set
    checkNotNull(
        request.getReservationLength(),
        "Missing the required parameter 'reservationLength' when calling sharedDataPackageInquiry");
    // verify the required parameter 'capacity' is set
    checkNotNull(
        request.getCapacity(),
        "Missing the required parameter 'capacity' when calling sharedDataPackageInquiry");
    InternalRequest internalRequest =
        this.createRequest(
            request, HttpMethodName.POST, VERSION_V1, CONSTANT_EIPTP, CONSTANT_PRICE);
    if (request.getClientToken() != null) {
      internalRequest.addParameter("clientToken", request.getClientToken());
    }
    fillPayload(internalRequest, request);
  ...
  public void startEipAutoRenew(StartEipAutoRenewRequest request) {
    ...
    // verify the required parameter 'eip' is set
    checkNotNull(
        request.getEip(), "Missing the required parameter 'eip' when calling startEipAutoRenew");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.PUT, VERSION_V1, CONSTANT_EIP, request.getEip());
  ...
  public void stopEipAutoRenew(StopEipAutoRenewRequest request) {
    ...
    // verify the required parameter 'eip' is set
    checkNotNull(
        request.getEip(), "Missing the required parameter 'eip' when calling stopEipAutoRenew");
    InternalRequest internalRequest =
        this.createRequest(
            new BaseBceRequest(), HttpMethodName.PUT, VERSION_V1, CONSTANT_EIP, request.getEip());
  ...
  public void unDirectEip(UnDirectEipRequest request) {
    // verify the required parameter 'eip' is set
    checkNotNull(request.getEip(), "Missing the required parameter 'eip' when calling unDirectEip");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    InternalRequest internalRequest =
  ...
  public void unbindTbspProtectionObject(UnbindTbspProtectionObjectRequest request) {
    ...
    checkNotNull(
        request.getId(),
        "Missing the required parameter 'id' when calling unbindTbspProtectionObject");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    // verify the required parameter 'ipList' is set
    checkNotNull(
        request.getIpList(),
        "Missing the required parameter 'ipList' when calling unbindTbspProtectionObject");
    InternalRequest internalRequest =
        this.createRequest(request, HttpMethodName.PUT, VERSION_V1, CONSTANT_TBSP, request.getId());
    internalRequest.addParameter("unbind", null);
    if (request.getClientToken() != null) {
  ...
  public void updateEipDeleteProtect(UpdateEipDeleteProtectRequest request) {
    ...
    checkNotNull(
        request.getEip(),
        "Missing the required parameter 'eip' when calling updateEipDeleteProtect");
    if (Strings.isNullOrEmpty(request.getClientToken())) {
      request.setClientToken(generateDefaultClientToken());
    }
    // verify the required parameter 'deleteProtect' is set
    checkNotNull(
        request.getDeleteProtect(),
        "Missing the required parameter 'deleteProtect' when calling updateEipDeleteProtect");
    InternalRequest internalRequest =
        this.createRequest(
            request,
            HttpMethodName.PUT,
   ...
   * @return A new request object populated with endpoint, resource path and specific parameters to
   *     send.
   */
  ...
  /**
   * the method to fill the internalRequest's content field with bceRequest only support
   * HttpMethodName.POST or HttpMethodName.PUT
   *
   * @param internalRequest A request object, populated with endpoint, resource path, ready for
   *     callers to populate any additional headers or parameters, and execute.
