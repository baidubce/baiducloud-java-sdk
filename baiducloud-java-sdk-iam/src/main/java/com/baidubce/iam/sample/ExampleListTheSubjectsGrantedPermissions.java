...
public class ExampleListTheSubjectsGrantedPermissions {
    public static void main(String[] args) {
        ...
        try {
            ListTheSubjectsGrantedPermissionsResponse response = client.listTheSubjectsGrantedPermissions(listTheSubjectsGrantedPermissionsRequest);
