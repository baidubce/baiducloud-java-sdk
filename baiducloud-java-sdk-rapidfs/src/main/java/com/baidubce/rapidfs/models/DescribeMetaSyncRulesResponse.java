...
public class DescribeMetaSyncRulesResponse extends BaseBceResponse {

    /**
    * 元数据同步规则信息列表，见附录 MetaSyncRuleInfo
    */
    private List<MetaSyncRuleInfo> metaSyncRuleInfos;
    ...
    */
    ...
    public String toString() {
        return "DescribeMetaSyncRulesResponse{" + "metaSyncRuleInfos=" + metaSyncRuleInfos + "\n" + "marker=" + marker + "\n" + "isTruncated=" + isTruncated + "\n" + "nextMarker="
                + nextMarker + "\n" + "maxKeys=" + maxKeys + "\n" + "}";
    }
