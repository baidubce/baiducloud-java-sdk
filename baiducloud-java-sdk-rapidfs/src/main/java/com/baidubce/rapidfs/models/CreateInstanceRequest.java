...
public class CreateInstanceRequest extends BaseBceRequest {
    ...
    */
    ...
    /**
    * 指定RapidFS 实例的zone，例如zoneA。
    */
    private String zone;

    /**
    * RapidFS 实例所在的 VPC 短ID，例如：vpc-6rug1kkkq8ca。
    */
    private String vpcId;

    /**
    * 子网短ID，注意 vpcId 和 subnetId 需要与 zone 匹配，例如：sbn-mcn9i27r44e6。
    */
    ...
    */
    ...
    /**
    * MasterManaged 部署模式下，用户运维管理的缓存接入类型 type 为 CCE 时必填，为容器引擎 CCE 集群 ID。
    */
    private String cceClusterId;

    /**
    * MasterManaged 部署模式下，用户运维管理的缓存接入类型 type 为 AIHC 时必填，为 AIHC 全托管资源池 ID。
    */
    private String aihcResourcePoolId;

    /**
    * MasterManaged 部署模式下，用户运维管理的缓存接入类型 type 为 K8S 时必填，为 K8s 集群内 RapidFS 缓存控制器 ID；需要在 controller 安装之后，通过 K8s 命令行查询获取：`kubectl get cm -n kube-system rapidfs-cache-service-config -o
    * yaml`
    */
    private String k8sControllerId;

    /**
    * MasterManaged 部署模式下，用户运维管理的缓存接入类型 type == K8S 时必填，为 K8s 集群内 RapidFS 缓存控制器 Token；需要在 controller 安装之后，通过 K8s 命令行 get controller 查询获取：`kubectl get cm -n kube-system
    * rapidfs-cache-service-config -o yaml`该字段需要基于请求 header x-bce-accesskey 对应的 secretkey
    ...
    */
    private String k8sControllerToken;

    /**
    * 实例 Token 初始更新周期，单位分钟，取值范围 [0, 43200(min)]；仅在 Master 托管类型且缓存接入类型为 K8S/CCE/AIHC 时有效。默认值 0 表示永不更新，Token 永久有效。
    */
    ...
    */
    ...
    public CreateInstanceRequest setZone(String zone) {
        this.zone = zone;
        return this;
    }
    ...
    public CreateInstanceRequest setSubnetId(String subnetId) {
    ...
    public CreateInstanceRequest setManagedMode(String managedMode) {
    ...
    public CreateInstanceRequest setMetaSpec(String metaSpec) {
    ...
    public CreateInstanceRequest setDataSpec(String dataSpec) {
    ...
    public CreateInstanceRequest setCapacityTiB(Integer capacityTiB) {
    ...
    public CreateInstanceRequest setCceClusterId(String cceClusterId) {
        this.cceClusterId = cceClusterId;
        return this;
    }

    public String getAihcResourcePoolId() {
        return aihcResourcePoolId;
    }

    public CreateInstanceRequest setAihcResourcePoolId(String aihcResourcePoolId) {
        this.aihcResourcePoolId = aihcResourcePoolId;
        return this;
    }

    public String getK8sControllerId() {
        return k8sControllerId;
    }

    public CreateInstanceRequest setK8sControllerId(String k8sControllerId) {
        this.k8sControllerId = k8sControllerId;
        return this;
    }

    public String getK8sControllerToken() {
        return k8sControllerToken;
    }

    public CreateInstanceRequest setK8sControllerToken(String k8sControllerToken) {
        this.k8sControllerToken = k8sControllerToken;
        return this;
    }
    ...
    public CreateInstanceRequest setTokenRefreshIntervalMinutes(Integer tokenRefreshIntervalMinutes) {
