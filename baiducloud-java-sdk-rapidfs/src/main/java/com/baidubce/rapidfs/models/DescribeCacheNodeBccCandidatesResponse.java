...
public class DescribeCacheNodeBccCandidatesResponse extends BaseBceResponse {

    /**
    * BCC 实例信息列表，见附录 BccInstanceInfo
    */
    private List<BccInstanceInfo> bccInstanceInfos;
    ...
    */
    ...
    public String toString() {
        return "DescribeCacheNodeBccCandidatesResponse{" + "bccInstanceInfos=" + bccInstanceInfos + "\n" + "marker=" + marker + "\n" + "isTruncated=" + isTruncated + "\n"
