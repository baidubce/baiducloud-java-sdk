...
public class LengthCheckInputStream extends FilterInputStream {
     ...
     * {@inheritDoc}
     *
     * @throws BceClientException if the data length read has exceeded the expected total, or if the total
     ...
     * {@inheritDoc}
     *
     * @throws BceClientException if {@link #includeSkipped} is true and the data length skipped has
