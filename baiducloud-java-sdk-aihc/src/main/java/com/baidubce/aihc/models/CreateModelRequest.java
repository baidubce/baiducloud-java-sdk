...
public class CreateModelRequest extends BaseBceRequest {
    ...
    */
    ...
    public CreateModelRequest setModelFormat(String modelFormat) {
    ...
    public CreateModelRequest setOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public CreateModelRequest setVisibilityScope(String visibilityScope) {
    ...
    public CreateModelRequest setInitVersionEntry(ModelVersionEntry initVersionEntry) {
