...
public class CreateDatasetRequest extends BaseBceRequest {
    ...
    */
    ...
    public CreateDatasetRequest setStorageInstance(String storageInstance) {
    ...
    public CreateDatasetRequest setImportFormat(String importFormat) {
    ...
    public CreateDatasetRequest setOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public CreateDatasetRequest setVisibilityScope(String visibilityScope) {
    ...
    public CreateDatasetRequest setVisibilityUser(List<PermissionEntry> visibilityUser) {
    ...
    public CreateDatasetRequest setVisibilityGroup(List<PermissionEntry> visibilityGroup) {
    ...
    public CreateDatasetRequest setInitVersionEntry(DatasetVersionEntry initVersionEntry) {
