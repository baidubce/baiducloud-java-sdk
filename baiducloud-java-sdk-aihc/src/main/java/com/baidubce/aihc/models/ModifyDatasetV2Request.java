...
public class ModifyDatasetV2Request extends BaseBceRequest {
    ...
    */
    ...
    public ModifyDatasetV2Request setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ModifyDatasetV2Request setDescription(String description) {
    ...
    public ModifyDatasetV2Request setVisibilityScope(String visibilityScope) {
    ...
    public ModifyDatasetV2Request setVisibilityUser(List<PermissionEntry> visibilityUser) {
    ...
    public ModifyDatasetV2Request setVisibilityGroup(List<PermissionEntry> visibilityGroup) {
