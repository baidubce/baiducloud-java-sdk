...
public class UpdateAlarmPolicyRequest extends BaseBceRequest {
    ...
    */
    ...
    public UpdateAlarmPolicyRequest setObjects(List<LogStore> objects) {
    ...
    public UpdateAlarmPolicyRequest setTargets(List<Target> targets) {
    ...
    public UpdateAlarmPolicyRequest setTriggerConditions(List<TriggerCondition> triggerConditions) {
    ...
    public UpdateAlarmPolicyRequest setGroups(List<String> groups) {
        this.groups = groups;
        return this;
    }
    ...
    public UpdateAlarmPolicyRequest setSchedule(Schedule schedule) {
    ...
    public UpdateAlarmPolicyRequest setRepeatIntervalMinute(Integer repeatIntervalMinute) {
    ...
    public UpdateAlarmPolicyRequest setRecoverWithoutNotice(Boolean recoverWithoutNotice) {
    ...
    public UpdateAlarmPolicyRequest setNoticeState(String noticeState) {
    ...
    public UpdateAlarmPolicyRequest setNotices(List<Notice> notices) {
    ...
    public UpdateAlarmPolicyRequest setNoticeRawLogs(List<NoticeRawLog> noticeRawLogs) {
