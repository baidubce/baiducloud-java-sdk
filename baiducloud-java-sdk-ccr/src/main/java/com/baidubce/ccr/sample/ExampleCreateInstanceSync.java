...
import com.baidubce.ccr.models.ReplicationSyncTriggerRequest;

public class ExampleCreateInstanceSync {
    public static void main(String[] args) {
        ...
        ReplicationSyncTriggerRequest trigger = new ReplicationSyncTriggerRequest();
        trigger.setType("");
        ...
        createInstanceSyncRequest.setTrigger(trigger);
        try {
            client.createInstanceSync(createInstanceSyncRequest);
