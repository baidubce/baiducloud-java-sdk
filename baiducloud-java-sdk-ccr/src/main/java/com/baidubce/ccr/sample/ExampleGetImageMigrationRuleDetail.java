...
public class ExampleGetImageMigrationRuleDetail {
    public static void main(String[] args) {
        ...
        try {
            GetImageMigrationRuleDetailResponse response = client.getImageMigrationRuleDetail(getImageMigrationRuleDetailRequest);
