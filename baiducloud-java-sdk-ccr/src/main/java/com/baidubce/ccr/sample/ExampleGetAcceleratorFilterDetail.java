...
public class ExampleGetAcceleratorFilterDetail {
    public static void main(String[] args) {
        ...
        try {
            GetAcceleratorFilterDetailResponse response = client.getAcceleratorFilterDetail(getAcceleratorFilterDetailRequest);
