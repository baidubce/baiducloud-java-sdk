...
public class DescribePlannedEventsRequest extends BaseBceRequest {
    ...
    */
    ...
    public DescribePlannedEventsRequest setAction(String action) {
        this.action = action;
        return this;
    }
    ...
    public DescribePlannedEventsRequest setServerEventStatus(String serverEventStatus) {
    ...
    public DescribePlannedEventsRequest setServerEventIds(List<String> serverEventIds) {
    ...
    public DescribePlannedEventsRequest setInstanceIds(List<String> instanceIds) {
    ...
    public DescribePlannedEventsRequest setProductCategory(String productCategory) {
    ...
    public DescribePlannedEventsRequest setServerEventType(String serverEventType) {
    ...
    public DescribePlannedEventsRequest setServerEventLogTimeFilter(String serverEventLogTimeFilter) {
    ...
    public DescribePlannedEventsRequest setPeriodStartTime(String periodStartTime) {
    ...
    public DescribePlannedEventsRequest setPeriodEndTime(String periodEndTime) {
    ...
    public DescribePlannedEventsRequest setMaxKeys(Integer maxKeys) {
    ...
    public DescribePlannedEventsRequest setMarker(String marker) {
        this.marker = marker;
        return this;
    }
