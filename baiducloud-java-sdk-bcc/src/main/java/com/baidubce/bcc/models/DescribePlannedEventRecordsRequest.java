...
public class DescribePlannedEventRecordsRequest extends BaseBceRequest {
    ...
    */
    ...
    public DescribePlannedEventRecordsRequest setAction(String action) {
        this.action = action;
        return this;
    }
    ...
    public DescribePlannedEventRecordsRequest setServerEventIds(List<String> serverEventIds) {
    ...
    public DescribePlannedEventRecordsRequest setInstanceIds(List<String> instanceIds) {
    ...
    public DescribePlannedEventRecordsRequest setProductCategory(String productCategory) {
    ...
    public DescribePlannedEventRecordsRequest setServerEventType(String serverEventType) {
    ...
    public DescribePlannedEventRecordsRequest setServerEventLogTimeFilter(String serverEventLogTimeFilter) {
    ...
    public DescribePlannedEventRecordsRequest setPeriodStartTime(String periodStartTime) {
    ...
    public DescribePlannedEventRecordsRequest setPeriodEndTime(String periodEndTime) {
    ...
    public DescribePlannedEventRecordsRequest setMaxKeys(Integer maxKeys) {
    ...
    public DescribePlannedEventRecordsRequest setMarker(String marker) {
        this.marker = marker;
        return this;
    }
