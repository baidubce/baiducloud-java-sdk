...
public class ExampleUnbindInstanceSecurityGroup {
    public static void main(String[] args) {
        ...
        try {
            UnbindInstanceSecurityGroupResponse response = client.unbindInstanceSecurityGroup(unbindInstanceSecurityGroupRequest);
