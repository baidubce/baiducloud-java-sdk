...
public class ExampleDescribePlannedEventRecords {
    public static void main(String[] args) {
        ...
        try {
            DescribePlannedEventRecordsResponse response = client.describePlannedEventRecords(describePlannedEventRecordsRequest);
