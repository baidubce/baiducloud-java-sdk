...
public class ExampleDeleteInstUserOpAuthorizeRule {
    public static void main(String[] args) {
        ...
        try {
            DeleteInstUserOpAuthorizeRuleResponse response = client.deleteInstUserOpAuthorizeRule(deleteInstUserOpAuthorizeRuleRequest);
