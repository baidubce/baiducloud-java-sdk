...
public class ExampleBusinesslicenseVerificationStandard {
    public static void main(String[] args) {
        ...
        try {
            BusinesslicenseVerificationStandardResponse response = client.businesslicenseVerificationStandard(businesslicenseVerificationStandardRequest);
