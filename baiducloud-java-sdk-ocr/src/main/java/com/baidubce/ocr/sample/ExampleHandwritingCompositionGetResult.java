...
public class ExampleHandwritingCompositionGetResult {
    public static void main(String[] args) {
        ...
        try {
            HandwritingCompositionGetResultResponse response = client.handwritingCompositionGetResult(handwritingCompositionGetResultRequest);
