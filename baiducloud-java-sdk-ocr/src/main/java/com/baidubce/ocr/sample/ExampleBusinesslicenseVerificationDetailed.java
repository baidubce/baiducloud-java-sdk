...
public class ExampleBusinesslicenseVerificationDetailed {
    public static void main(String[] args) {
        ...
        try {
            BusinesslicenseVerificationDetailedResponse response = client.businesslicenseVerificationDetailed(businesslicenseVerificationDetailedRequest);
