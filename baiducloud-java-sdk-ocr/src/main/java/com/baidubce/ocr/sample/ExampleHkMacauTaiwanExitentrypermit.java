...
public class ExampleHkMacauTaiwanExitentrypermit {
    public static void main(String[] args) {
        ...
        try {
            HkMacauTaiwanExitentrypermitResponse response = client.hkMacauTaiwanExitentrypermit(hkMacauTaiwanExitentrypermitRequest);
