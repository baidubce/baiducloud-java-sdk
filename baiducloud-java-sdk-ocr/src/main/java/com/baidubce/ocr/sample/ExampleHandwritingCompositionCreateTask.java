...
public class ExampleHandwritingCompositionCreateTask {
    public static void main(String[] args) {
        ...
        try {
            HandwritingCompositionCreateTaskResponse response = client.handwritingCompositionCreateTask(handwritingCompositionCreateTaskRequest);
