...
public class ForeignResidentIdCardRequest extends BaseBceRequest {
    ...
    */
    ...
    public ForeignResidentIdCardRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public ForeignResidentIdCardRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public ForeignResidentIdCardRequest setPdfFile(String pdfFile) {
    ...
    public ForeignResidentIdCardRequest setPdfFileNum(Integer pdfFileNum) {
