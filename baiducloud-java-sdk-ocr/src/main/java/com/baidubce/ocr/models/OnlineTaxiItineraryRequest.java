...
public class OnlineTaxiItineraryRequest extends BaseBceRequest {
    ...
    */
    ...
    /**
    * OFD文件，base64编码后进行urlencode，要求base64编码和urlencode后大小不超过8M，最短边至少15px，最长边最大4096px。<br/>优先级：image > url > pdf_file > ofd_file，当image、url字段存在时，pdf_file字段失效
    */
    ...
    */
    ...
    public OnlineTaxiItineraryRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public OnlineTaxiItineraryRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public OnlineTaxiItineraryRequest setPdfFile(String pdfFile) {
    ...
    public OnlineTaxiItineraryRequest setPdfFileNum(Integer pdfFileNum) {
    ...
    public OnlineTaxiItineraryRequest setOfdFile(String ofdFile) {
    ...
    public OnlineTaxiItineraryRequest setOfdFileNum(Integer ofdFileNum) {
