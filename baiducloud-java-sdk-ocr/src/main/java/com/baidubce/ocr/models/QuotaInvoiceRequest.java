...
public class QuotaInvoiceRequest extends BaseBceRequest {
    ...
    */
    ...
    public QuotaInvoiceRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public QuotaInvoiceRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public QuotaInvoiceRequest setPdfFile(String pdfFile) {
    ...
    public QuotaInvoiceRequest setPdfFileNum(Integer pdfFileNum) {
    ...
    public QuotaInvoiceRequest setOfdFile(String ofdFile) {
    ...
    public QuotaInvoiceRequest setOfdFileNum(Integer ofdFileNum) {
