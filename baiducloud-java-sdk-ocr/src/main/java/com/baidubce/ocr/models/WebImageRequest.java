...
public class WebImageRequest extends BaseBceRequest {
    ...
    */
    ...
    public WebImageRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public WebImageRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public WebImageRequest setPdfFile(String pdfFile) {
    ...
    public WebImageRequest setPdfFileNum(Integer pdfFileNum) {
    ...
    public WebImageRequest setOfdFile(String ofdFile) {
    ...
    public WebImageRequest setOfdFileNum(Integer ofdFileNum) {
    ...
    public WebImageRequest setDetectDirection(Boolean detectDirection) {
    ...
    public WebImageRequest setDetectLanguage(Boolean detectLanguage) {
