...
public class RoadTransportCertificateRequest extends BaseBceRequest {
    ...
    */
    ...
    public RoadTransportCertificateRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public RoadTransportCertificateRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public RoadTransportCertificateRequest setPdfFile(String pdfFile) {
    ...
    public RoadTransportCertificateRequest setPdfFileNum(Integer pdfFileNum) {
