...
public class InvoiceRequest extends BaseBceRequest {
    ...
    */
    ...
    public InvoiceRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public InvoiceRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public InvoiceRequest setPdfFile(String pdfFile) {
    ...
    public InvoiceRequest setPdfFileNum(Integer pdfFileNum) {
    ...
    public InvoiceRequest setOfdFile(String ofdFile) {
    ...
    public InvoiceRequest setOfdFileNum(Integer ofdFileNum) {
