...
public class MedicalReportDetectionRequest extends BaseBceRequest {
    ...
    */
    ...
    public MedicalReportDetectionRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public MedicalReportDetectionRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public MedicalReportDetectionRequest setLocation(Boolean location) {
    ...
    public MedicalReportDetectionRequest setProbability(Boolean probability) {
