...
public class BankReceiptNewRequest extends BaseBceRequest {
    ...
    */
    ...
    public BankReceiptNewRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public BankReceiptNewRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public BankReceiptNewRequest setPdfFile(String pdfFile) {
    ...
    public BankReceiptNewRequest setPdfFileNum(Integer pdfFileNum) {
    ...
    public BankReceiptNewRequest setOfdFile(String ofdFile) {
    ...
    public BankReceiptNewRequest setOfdFileNum(Integer ofdFileNum) {
    ...
    public BankReceiptNewRequest setProbability(Boolean probability) {
    ...
    public BankReceiptNewRequest setLocation(Boolean location) {
