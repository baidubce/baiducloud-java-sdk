...
public class ParserQueryResult {
    ...
    public ParserQueryResult setTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public ParserQueryResult setStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ParserQueryResult setTaskError(String taskError) {
    ...
    public ParserQueryResult setMarkdownUrl(String markdownUrl) {
    ...
    public ParserQueryResult setParseResultUrl(String parseResultUrl) {
    ...
    public String toString() {
        return "ParserQueryResult{" + "taskId=" + taskId + "\n" + "status=" + status + "\n" + "taskError=" + taskError + "\n" + "markdownUrl=" + markdownUrl + "\n"
