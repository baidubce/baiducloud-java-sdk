...
public class HkMacauTaiwanExitentrypermitRequest extends BaseBceRequest {
    ...
    */
    ...
    public HkMacauTaiwanExitentrypermitRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public HkMacauTaiwanExitentrypermitRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public HkMacauTaiwanExitentrypermitRequest setPdfFile(String pdfFile) {
    ...
    public HkMacauTaiwanExitentrypermitRequest setPdfFileNum(Integer pdfFileNum) {
    ...
    public HkMacauTaiwanExitentrypermitRequest setExitentrypermitType(String exitentrypermitType) {
    ...
    public HkMacauTaiwanExitentrypermitRequest setProbability(Boolean probability) {
    ...
    public HkMacauTaiwanExitentrypermitRequest setLocation(Boolean location) {
