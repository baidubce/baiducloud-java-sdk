...
public class GeneralRequest extends BaseBceRequest {
    ...
    */
    ...
    public GeneralRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public GeneralRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public GeneralRequest setPdfFile(String pdfFile) {
    ...
    public GeneralRequest setPdfFileNum(Integer pdfFileNum) {
    ...
    public GeneralRequest setOfdFile(String ofdFile) {
    ...
    public GeneralRequest setOfdFileNum(Integer ofdFileNum) {
    ...
    public GeneralRequest setRecognizeGranularity(String recognizeGranularity) {
    ...
    public GeneralRequest setLanguageType(String languageType) {
    ...
    public GeneralRequest setDetectDirection(Boolean detectDirection) {
    ...
    public GeneralRequest setDetectLanguage(Boolean detectLanguage) {
    ...
    public GeneralRequest setParagraph(Boolean paragraph) {
    ...
    public GeneralRequest setVertexesLocation(Boolean vertexesLocation) {
    ...
    public GeneralRequest setProbability(Boolean probability) {
