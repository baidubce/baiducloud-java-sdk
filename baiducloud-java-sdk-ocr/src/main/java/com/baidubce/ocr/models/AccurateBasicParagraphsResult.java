...
public class AccurateBasicParagraphsResult {
    /**
    ...
    public AccurateBasicParagraphsResult setWordsResultIdx(List<Integer> wordsResultIdx) {
    ...
    public String toString() {
        return "AccurateBasicParagraphsResult{" + "wordsResultIdx=" + wordsResultIdx + "\n" + "}";
    }
