...
public class MedicalRecordRequest extends BaseBceRequest {
    ...
    */
    ...
    public MedicalRecordRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public MedicalRecordRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public MedicalRecordRequest setLocation(Boolean location) {
    ...
    public MedicalRecordRequest setProbability(Boolean probability) {
