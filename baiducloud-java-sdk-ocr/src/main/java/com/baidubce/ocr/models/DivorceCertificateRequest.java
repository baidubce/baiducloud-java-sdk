...
public class DivorceCertificateRequest extends BaseBceRequest {
    ...
    */
    ...
    public DivorceCertificateRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public DivorceCertificateRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public DivorceCertificateRequest setPdfFile(String pdfFile) {
    ...
    public DivorceCertificateRequest setPdfFileNum(Integer pdfFileNum) {
