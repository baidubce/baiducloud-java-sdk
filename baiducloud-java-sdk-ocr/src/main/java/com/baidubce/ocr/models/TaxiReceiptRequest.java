...
public class TaxiReceiptRequest extends BaseBceRequest {
    ...
    */
    ...
    public TaxiReceiptRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public TaxiReceiptRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public TaxiReceiptRequest setPdfFile(String pdfFile) {
    ...
    public TaxiReceiptRequest setPdfFileNum(Integer pdfFileNum) {
    ...
    public TaxiReceiptRequest setOfdFile(String ofdFile) {
    ...
    public TaxiReceiptRequest setOfdFileNum(Integer ofdFileNum) {
