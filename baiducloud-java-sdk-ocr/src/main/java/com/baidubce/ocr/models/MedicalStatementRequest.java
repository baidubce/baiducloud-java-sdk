...
public class MedicalStatementRequest extends BaseBceRequest {
    ...
    */
    ...
    public MedicalStatementRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public MedicalStatementRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public MedicalStatementRequest setLocation(Boolean location) {
    ...
    public MedicalStatementRequest setProbability(Boolean probability) {
