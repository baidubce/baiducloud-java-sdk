...
public class QrcodeRequest extends BaseBceRequest {
    ...
    */
    ...
    /**
    * 是否输出二维码/条形码位置信息。false：不返回位置信息；true：返回图中二维码/条形码的位置信息，包括上边距、左边距、宽度、高度
    */
    ...
    public QrcodeRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public QrcodeRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public QrcodeRequest setPdfFile(String pdfFile) {
    ...
    public QrcodeRequest setPdfFileNum(Integer pdfFileNum) {
    ...
    public QrcodeRequest setOfdFile(String ofdFile) {
    ...
    public QrcodeRequest setOfdFileNum(Integer ofdFileNum) {
    ...
    public QrcodeRequest setLocation(Boolean location) {
