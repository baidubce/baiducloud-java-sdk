...
public class ShoppingReceiptRequest extends BaseBceRequest {
    ...
    */
    ...
    public ShoppingReceiptRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public ShoppingReceiptRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public ShoppingReceiptRequest setPdfFile(String pdfFile) {
    ...
    public ShoppingReceiptRequest setPdfFileNum(Integer pdfFileNum) {
    ...
    public ShoppingReceiptRequest setOfdFile(String ofdFile) {
    ...
    public ShoppingReceiptRequest setOfdFileNum(Integer ofdFileNum) {
    ...
    public ShoppingReceiptRequest setProbability(Boolean probability) {
    ...
    public ShoppingReceiptRequest setLocation(Boolean location) {
