...
public class TrainTicketRequest extends BaseBceRequest {
    ...
    */
    ...
    public TrainTicketRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public TrainTicketRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public TrainTicketRequest setPdfFile(String pdfFile) {
    ...
    public TrainTicketRequest setPdfFileNum(Integer pdfFileNum) {
    ...
    public TrainTicketRequest setOfdFile(String ofdFile) {
    ...
    public TrainTicketRequest setOfdFileNum(Integer ofdFileNum) {
