...
public class FerryTicketRequest extends BaseBceRequest {
    ...
    */
    ...
    public FerryTicketRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public FerryTicketRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public FerryTicketRequest setPdfFile(String pdfFile) {
    ...
    public FerryTicketRequest setPdfFileNum(Integer pdfFileNum) {
    ...
    public FerryTicketRequest setOfdFile(String ofdFile) {
    ...
    public FerryTicketRequest setOfdFileNum(Integer ofdFileNum) {
