...
public class TollInvoiceRequest extends BaseBceRequest {
    ...
    */
    ...
    public TollInvoiceRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public TollInvoiceRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public TollInvoiceRequest setPdfFile(String pdfFile) {
    ...
    public TollInvoiceRequest setPdfFileNum(Integer pdfFileNum) {
    ...
    public TollInvoiceRequest setOfdFile(String ofdFile) {
    ...
    public TollInvoiceRequest setOfdFileNum(Integer ofdFileNum) {
