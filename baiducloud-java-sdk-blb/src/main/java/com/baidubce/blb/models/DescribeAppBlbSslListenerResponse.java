...
public class DescribeAppBlbSslListenerResponse extends BaseBceResponse {

    /**
    * 包含查询结果的列表
    */
    private List<AppSSLListenerModel> listenerList;
    ...
    */
    ...
    public String toString() {
        return "DescribeAppBlbSslListenerResponse{" + "listenerList=" + listenerList + "\n" + "marker=" + marker + "\n" + "isTruncated=" + isTruncated + "\n" + "nextMarker="
                + nextMarker + "\n" + "maxKeys=" + maxKeys + "\n" + "}";
    }
