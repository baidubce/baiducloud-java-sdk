...
public class CreateBlbSslListenerRequest extends BaseBceRequest {
    ...
    */
    ...
    /**
    * 后端服务器最大超时（单位：秒）（单位：秒），默认900，需为10-4000间的整数
    */
    ...
    */
    ...
    public CreateBlbSslListenerRequest setBlbId(String blbId) {
        this.blbId = blbId;
        return this;
    }
    ...
    public CreateBlbSslListenerRequest setClientToken(String clientToken) {
    ...
    public CreateBlbSslListenerRequest setListenerPort(Integer listenerPort) {
    ...
    public CreateBlbSslListenerRequest setBackendPort(Integer backendPort) {
    ...
    public CreateBlbSslListenerRequest setScheduler(String scheduler) {
    ...
    public CreateBlbSslListenerRequest setHealthCheckType(String healthCheckType) {
    ...
    public CreateBlbSslListenerRequest setServerTimeout(Integer serverTimeout) {
    ...
    public CreateBlbSslListenerRequest setHealthCheckTimeoutInSecond(Integer healthCheckTimeoutInSecond) {
    ...
    public CreateBlbSslListenerRequest setHealthCheckInterval(Integer healthCheckInterval) {
    ...
    public CreateBlbSslListenerRequest setUnhealthyThreshold(Integer unhealthyThreshold) {
    ...
    public CreateBlbSslListenerRequest setHealthyThreshold(Integer healthyThreshold) {
    ...
    public CreateBlbSslListenerRequest setCertIds(List<String> certIds) {
    ...
    public CreateBlbSslListenerRequest setEncryptionType(String encryptionType) {
    ...
    public CreateBlbSslListenerRequest setEncryptionProtocols(List<String> encryptionProtocols) {
    ...
    public CreateBlbSslListenerRequest setAppliedCiphers(String appliedCiphers) {
    ...
    public CreateBlbSslListenerRequest setDualAuth(Boolean dualAuth) {
    ...
    public CreateBlbSslListenerRequest setClientCertIds(List<String> clientCertIds) {
