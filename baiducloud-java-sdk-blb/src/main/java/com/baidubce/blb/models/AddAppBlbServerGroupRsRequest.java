...
public class AddAppBlbServerGroupRsRequest extends BaseBceRequest {
    ...
    */
    ...
    public AddAppBlbServerGroupRsRequest setBlbId(String blbId) {
        this.blbId = blbId;
        return this;
    }
    ...
    public AddAppBlbServerGroupRsRequest setClientToken(String clientToken) {
    ...
    public AddAppBlbServerGroupRsRequest setSgId(String sgId) {
        this.sgId = sgId;
        return this;
    }
