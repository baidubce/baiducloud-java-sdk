...
public class DescribeAppBlbUdpListenerResponse extends BaseBceResponse {

    /**
    * 包含查询结果的列表
    */
    private List<AppUDPListenerModel> listenerList;
    ...
    */
    ...
    public String toString() {
        return "DescribeAppBlbUdpListenerResponse{" + "listenerList=" + listenerList + "\n" + "marker=" + marker + "\n" + "isTruncated=" + isTruncated + "\n" + "nextMarker="
                + nextMarker + "\n" + "maxKeys=" + maxKeys + "\n" + "}";
    }
