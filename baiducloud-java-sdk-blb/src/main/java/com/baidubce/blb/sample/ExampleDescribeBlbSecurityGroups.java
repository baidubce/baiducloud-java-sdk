...
public class ExampleDescribeBlbSecurityGroups {
    public static void main(String[] args) {
        ...
        try {
            DescribeBlbSecurityGroupsResponse response = client.describeBlbSecurityGroups(describeBlbSecurityGroupsRequest);
