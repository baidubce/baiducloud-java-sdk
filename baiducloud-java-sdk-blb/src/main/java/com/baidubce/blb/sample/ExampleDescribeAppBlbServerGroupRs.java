...
public class ExampleDescribeAppBlbServerGroupRs {
    public static void main(String[] args) {
        ...
        try {
            DescribeAppBlbServerGroupRsResponse response = client.describeAppBlbServerGroupRs(describeAppBlbServerGroupRsRequest);
