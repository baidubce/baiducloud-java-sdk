...
public class ExampleDescribeAppBlbHttpListener {
    public static void main(String[] args) {
        ...
        try {
            DescribeAppBlbHttpListenerResponse response = client.describeAppBlbHttpListener(describeAppBlbHttpListenerRequest);
