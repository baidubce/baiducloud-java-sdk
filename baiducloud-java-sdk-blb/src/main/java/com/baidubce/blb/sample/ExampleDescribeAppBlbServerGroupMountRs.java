...
public class ExampleDescribeAppBlbServerGroupMountRs {
    public static void main(String[] args) {
        ...
        try {
            DescribeAppBlbServerGroupMountRsResponse response = client.describeAppBlbServerGroupMountRs(describeAppBlbServerGroupMountRsRequest);
