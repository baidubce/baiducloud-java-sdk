...
public class ExampleDescribeAppBlbTcpListener {
    public static void main(String[] args) {
        ...
        try {
            DescribeAppBlbTcpListenerResponse response = client.describeAppBlbTcpListener(describeAppBlbTcpListenerRequest);
