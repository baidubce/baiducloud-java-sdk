...
public class ExampleDescribeAppBlbServerGroup {
    public static void main(String[] args) {
        ...
        try {
            DescribeAppBlbServerGroupResponse response = client.describeAppBlbServerGroup(describeAppBlbServerGroupRequest);
