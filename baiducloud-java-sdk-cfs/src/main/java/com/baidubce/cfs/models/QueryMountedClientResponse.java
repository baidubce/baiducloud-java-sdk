...
public class QueryMountedClientResponse extends BaseBceResponse {

    /**
    * 包含查询结果的列表
    */
    private List<ClientInfoModel> clientInfoList;
    ...
    */
    ...
    public String toString() {
        return "QueryMountedClientResponse{" + "clientInfoList=" + clientInfoList + "\n" + "marker=" + marker + "\n" + "isTruncated=" + isTruncated + "\n" + "nextMarker="
                + nextMarker + "\n" + "maxKeys=" + maxKeys + "\n" + "}";
    }
