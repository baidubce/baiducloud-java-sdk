...
public class ExampleCreatePermissionGroupRules {
    public static void main(String[] args) {
        ...
        try {
            CreatePermissionGroupRulesResponse response = client.createPermissionGroupRules(createPermissionGroupRulesRequest);
