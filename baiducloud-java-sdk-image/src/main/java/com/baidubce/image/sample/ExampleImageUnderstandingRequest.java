...
public class ExampleImageUnderstandingRequest {
    public static void main(String[] args) {
        ...
        try {
            ImageUnderstandingRequestResponse response = client.imageUnderstandingRequest(imageUnderstandingRequestRequest);
