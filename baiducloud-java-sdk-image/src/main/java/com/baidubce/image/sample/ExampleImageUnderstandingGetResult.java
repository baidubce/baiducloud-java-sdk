...
public class ExampleImageUnderstandingGetResult {
    public static void main(String[] args) {
        ...
        try {
            ImageUnderstandingGetResultResponse response = client.imageUnderstandingGetResult(imageUnderstandingGetResultRequest);
