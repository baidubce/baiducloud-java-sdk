...
public class SameImageUpdateRequest extends BaseBceRequest {
    ...
    */
    ...
    public SameImageUpdateRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public SameImageUpdateRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public SameImageUpdateRequest setContSign(String contSign) {
    ...
    public SameImageUpdateRequest setBrief(String brief) {
        this.brief = brief;
        return this;
    }
    ...
    public SameImageUpdateRequest setTags(String tags) {
        this.tags = tags;
        return this;
    }
