...
public class PicturebookImageDeleteRequest extends BaseBceRequest {
    ...
    */
    ...
    public PicturebookImageDeleteRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public PicturebookImageDeleteRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public PicturebookImageDeleteRequest setContSign(String contSign) {
