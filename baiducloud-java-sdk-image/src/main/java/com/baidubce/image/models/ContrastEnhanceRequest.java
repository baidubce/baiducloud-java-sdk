...
public class ContrastEnhanceRequest extends BaseBceRequest {
    ...
    */
    ...
    public ContrastEnhanceRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public ContrastEnhanceRequest setUrl(String url) {
        this.url = url;
        return this;
    }
