...
public class StretchRestoreRequest extends BaseBceRequest {
    ...
    */
    ...
    public StretchRestoreRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public StretchRestoreRequest setUrl(String url) {
        this.url = url;
        return this;
    }
