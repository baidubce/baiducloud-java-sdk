...
public class SimilarImageDeleteRequest extends BaseBceRequest {
    ...
    */
    ...
    public SimilarImageDeleteRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public SimilarImageDeleteRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public SimilarImageDeleteRequest setContSign(String contSign) {
