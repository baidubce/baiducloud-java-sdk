...
public class SimilarImageAddRequest extends BaseBceRequest {
    ...
    */
    ...
    public SimilarImageAddRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public SimilarImageAddRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public SimilarImageAddRequest setBrief(String brief) {
        this.brief = brief;
        return this;
    }
    ...
    public SimilarImageAddRequest setTags(String tags) {
        this.tags = tags;
        return this;
    }
