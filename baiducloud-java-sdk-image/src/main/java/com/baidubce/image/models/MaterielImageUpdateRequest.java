...
public class MaterielImageUpdateRequest extends BaseBceRequest {
    ...
    */
    ...
    public MaterielImageUpdateRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public MaterielImageUpdateRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public MaterielImageUpdateRequest setContSign(String contSign) {
    ...
    public MaterielImageUpdateRequest setBrief(String brief) {
        this.brief = brief;
        return this;
    }
    ...
    public MaterielImageUpdateRequest setTags(String tags) {
        this.tags = tags;
        return this;
    }
