...
public class MaterielImageDeleteRequest extends BaseBceRequest {
    ...
    */
    ...
    public MaterielImageDeleteRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public MaterielImageDeleteRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public MaterielImageDeleteRequest setContSign(String contSign) {
