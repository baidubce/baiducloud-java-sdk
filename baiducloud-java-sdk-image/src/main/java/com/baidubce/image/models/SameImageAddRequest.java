...
public class SameImageAddRequest extends BaseBceRequest {
    ...
    */
    ...
    public SameImageAddRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public SameImageAddRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public SameImageAddRequest setBrief(String brief) {
        this.brief = brief;
        return this;
    }
    ...
    public SameImageAddRequest setTags(String tags) {
        this.tags = tags;
        return this;
    }
