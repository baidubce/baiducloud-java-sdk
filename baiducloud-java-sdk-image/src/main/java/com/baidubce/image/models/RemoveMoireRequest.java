...
public class RemoveMoireRequest extends BaseBceRequest {
    ...
    */
    ...
    /**
    * 图片完整url，url长度不超过1024字节，url对应的图片base64编码后大小不超过4M，最短边至少15px，最长边最大4096px，支持jpg/jpeg/png/bmp格式 <br/>优先级：image > url > pdf_file，当image字段存在时，url字段失效<br/>请注意关闭URL防盗链
    */
    private String url;
    ...
    */
    ...
    public RemoveMoireRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public RemoveMoireRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public RemoveMoireRequest setPdfFile(String pdfFile) {
    ...
    public RemoveMoireRequest setPdfFileNum(Integer pdfFileNum) {
