...
public class AnimalRequest extends BaseBceRequest {
    ...
    */
    ...
    public AnimalRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public AnimalRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public AnimalRequest setTopNum(Integer topNum) {
        this.topNum = topNum;
        return this;
    }
    ...
    public AnimalRequest setBaikeNum(Integer baikeNum) {
