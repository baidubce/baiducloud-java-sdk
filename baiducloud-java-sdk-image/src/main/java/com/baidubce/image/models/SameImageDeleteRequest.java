...
public class SameImageDeleteRequest extends BaseBceRequest {
    ...
    */
    ...
    public SameImageDeleteRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public SameImageDeleteRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public SameImageDeleteRequest setContSign(String contSign) {
