...
public class SameImageSearchRequest extends BaseBceRequest {
    ...
    */
    ...
    public SameImageSearchRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public SameImageSearchRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public SameImageSearchRequest setTags(String tags) {
        this.tags = tags;
        return this;
    }
    ...
    public SameImageSearchRequest setTagLogic(Integer tagLogic) {
    ...
    public SameImageSearchRequest setPn(Integer pn) {
        this.pn = pn;
        return this;
    }
    ...
    public SameImageSearchRequest setRn(Integer rn) {
        this.rn = rn;
        return this;
    }
