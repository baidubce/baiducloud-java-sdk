...
public class MaterielImageAddRequest extends BaseBceRequest {
    ...
    */
    ...
    public MaterielImageAddRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public MaterielImageAddRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public MaterielImageAddRequest setBrief(String brief) {
        this.brief = brief;
        return this;
    }
    ...
    public MaterielImageAddRequest setTags(String tags) {
        this.tags = tags;
        return this;
    }
