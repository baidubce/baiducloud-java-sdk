...
public class PicturebookImageUpdateRequest extends BaseBceRequest {
    ...
    */
    ...
    public PicturebookImageUpdateRequest setImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public PicturebookImageUpdateRequest setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public PicturebookImageUpdateRequest setContSign(String contSign) {
    ...
    public PicturebookImageUpdateRequest setBrief(String brief) {
        this.brief = brief;
        return this;
    }
    ...
    public PicturebookImageUpdateRequest setTags(String tags) {
        this.tags = tags;
        return this;
    }
