...
public class GetLatestReportResponse extends BaseBceResponse {
    ...
    */
    ...
    public GetLatestReportResponse setTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public GetLatestReportResponse setInspectionItemsCount(Integer inspectionItemsCount) {
    ...
    public GetLatestReportResponse setReportItems(Map<String, Map<String, InspectionItemInfo>> reportItems) {
    ...
    public GetLatestReportResponse setInspectStartTime(String inspectStartTime) {
    ...
    public GetLatestReportResponse setReportDeliveryStatus(Object reportDeliveryStatus) {
